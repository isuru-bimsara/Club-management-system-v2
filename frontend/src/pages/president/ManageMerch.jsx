// //frontend/src/pages/president/ManageMerch.jsx
...
//   const [form, setForm] = useState({ name: '', price: '', totalQuantity: '', image: null });
//   const [loading, setLoading] = useState(true);

//   const load = async () => {
//     setLoading(true);
//     const list = await merchService.getEventMerch(eventId);
//     setItems(list.filter((m) => m.createdBy)); // show any
//     setLoading(false);
//   };
...
//       setForm({ name: '', price: '', totalQuantity: '', image: null });
//       setBanks([blankBank]);
//       load();
//     } catch (err) {
...
//           <input className="input md:col-span-3" type="file" accept="image/*" onChange={(e)=>setForm({...form,image:e.target.files[0]})} />
//         </div>
